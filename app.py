...
client = pymongo.MongoClient(
    "mongodb+srv://anie81008:fpDddNmVvMxgjH89@cluster11.dyvix.mongodb.net/?retryWrites=true&w=majority&appName=Cluster11",
...
def profile():
    return render_template(
        ...
        total_todos=todos.count_documents({"user_id": session["user_id"]}),
    )
